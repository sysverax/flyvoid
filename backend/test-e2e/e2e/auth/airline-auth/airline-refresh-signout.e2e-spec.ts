...
const REFRESH_PATH = "/api/v1/auth/airline/refresh";
const SIGNOUT_PATH = "/api/v1/auth/airline/signout";
...
wrapResponseLogging(REFRESH_PATH);
wrapResponseLogging(SIGNOUT_PATH);
