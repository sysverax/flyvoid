...
const DISABLE_PATH = "/api/v1/auth/airline/2fa/disable";
const RECOVER_PATH = "/api/v1/auth/airline/2fa/recover";
...
wrapResponseLogging(DISABLE_PATH);
wrapResponseLogging(RECOVER_PATH);
