...
- TC_AIRLINE_2FA_DISABLE_004: Unknown field in disable payload -> 400
- TC_AIRLINE_2FA_DISABLE_005: Missing twoFactorCode field -> 400
...
- TC_AIRLINE_2FA_RECOVER_004: Recovery code is single-use — reuse after successful recovery -> 401
- TC_AIRLINE_2FA_RECOVER_005: Missing required fields (email or recoveryCode) -> 400
...
- TC_AIRLINE_2FA_SETUP_003: 2FA already enabled — repeat setup attempt -> 409
...
- TC_AIRLINE_2FA_ENABLE_005: Missing twoFactorCode field -> 400
- TC_AIRLINE_2FA_ENABLE_006: Non-string twoFactorCode (numeric) -> 400

### airline-forgot-password.e2e-spec

- Spec file: airline-forgot-password.e2e-spec.ts
- Context: Airline forgot password flow
- Reset endpoint: POST /api/v1/auth/airline/forgot-password (not /reset)
...
- TC_AIRLINE_FORGOT_SEND_004: send-otp with unknown field -> 400
- TC_AIRLINE_FORGOT_SEND_005: send-otp missing email field -> 400
...
- TC_AIRLINE_FORGOT_VERIFY_004: verify-otp with unknown field -> 400
- TC_AIRLINE_FORGOT_VERIFY_005: verify-otp missing otp field -> 400
...
- TC_AIRLINE_FORGOT_RESET_004: Missing required fields (token or password) -> 400
- TC_AIRLINE_FORGOT_RESET_005: Type coercion — numeric resetPasswordToken -> 400
...
- TC_AIRLINE_ONBOARD_010: Conflict when company registration number already exists -> 409
- TC_AIRLINE_ONBOARD_011: Missing password field -> 400
- TC_AIRLINE_ONBOARD_012: Non-string invitationToken (numeric) -> 400
- TC_AIRLINE_ONBOARD_013: Non-string password (boolean) -> 400
...
- TC_AIRLINE_REFRESH_004: Refresh token invalidated after forgot-password reset -> 401
- TC_AIRLINE_REFRESH_005: Missing refreshToken field -> 400
...
- TC_AIRLINE_SIGNOUT_005: Using own accessToken as body refreshToken field -> 401
- TC_AIRLINE_SIGNOUT_006: Tampered refreshToken signature in body -> 401
...
- TC_AIRLINE_SIGNIN_003: Inactive airline user signin -> 401
...
- TC_AIRLINE_SIGNIN_008: Email case insensitivity (uppercase email) -> 200
- TC_AIRLINE_SIGNIN_009: Successful response includes accessTokenExpiresIn and refreshTokenExpiresIn -> 200
- TC_AIRLINE_SIGNIN_010: Inactive airline (airline-level isActive=false) signin -> 401
...
- TC_AIRLINE_2FA_VERIFY_007: twoFactorToken is single-use — reuse after successful verify -> 401
- TC_AIRLINE_2FA_VERIFY_008: Successful response includes accessToken and refreshToken -> 200
...
- TC_AIRLINE_RESET_006: Missing resetPasswordToken field -> 400
- TC_AIRLINE_RESET_007: Missing newPassword field -> 400
- TC_AIRLINE_RESET_008: Non-string resetPasswordToken (numeric) -> 400
- TC_AIRLINE_RESET_009: Non-string newPassword (boolean) -> 400
- TC_AIRLINE_RESET_010: Successful reset response shape (accessToken/refreshToken when returned) -> 200
