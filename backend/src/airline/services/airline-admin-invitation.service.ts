...
@Injectable()
export class AirlineAdminInvitationService {
  private readonly context = "AirlineAdminInvitationService";
  ...
  async inviteAirlineAdmin(
    ...
    const invite = await this.airlineInvitationRepository.createAirlineAdminInvite(
      {
