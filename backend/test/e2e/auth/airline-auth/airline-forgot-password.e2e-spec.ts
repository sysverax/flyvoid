...
const SEND_OTP_PATH = "/api/v1/auth/airline/forgot-password/send-otp";
const VERIFY_OTP_PATH = "/api/v1/auth/airline/forgot-password/verify-otp";
const RESET_PATH = "/api/v1/auth/airline/forgot-password";
...
wrapResponseLogging(SEND_OTP_PATH);
wrapResponseLogging(VERIFY_OTP_PATH);
wrapResponseLogging(RESET_PATH);
