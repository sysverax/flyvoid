      ...
      <div className="w-full bg-white rounded-[16px] border border-gray-200 p-6 sm:p-8 flex flex-col gap-6 animate-fadeIn">
        ...
        <form onSubmit={handleSignIn} className="flex flex-col gap-5" noValidate>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full h-[48px] rounded-[10px] bg-[#0F2757] hover:bg-[#162259] active:bg-[#091a3c] text-white text-lg transition-all duration-150 flex items-center justify-center gap-2 shadow-lg shadow-[#0F2757]/10 cursor-pointer disabled:opacity-75 disabled:cursor-default font-figtree -translate-y-0.5"
          >
            {isLoading ? (
              <>
