...
export default function ForgotPasswordPage() {
    ...
    return (
      <div className="flex items-center justify-center gap-2 mb-4 relative select-none">
        ...
        <div className={cn(
          ...
          step > 1 ? "bg-[#1FAD53] text-white" : "bg-[#0F2757] text-white"
        )}>
          {step > 1 ? (
        ...
        <div className={cn(
          "w-7 h-7 rounded-full flex items-center justify-center text-xs font-semibold font-figtree transition-all duration-300",
          step > 2 ? "bg-[#1FAD53] text-white" : step === 2 ? "bg-[#0F2757] text-white" : "bg-[#EEEFF1] text-gray-500"
        )}>
          {step > 2 ? (
            <img src="/icons/tick.svg" alt="tick" className="w-4 h-4" />
          ) : "2"}
        ...
        <div className={cn(
          "w-7 h-7 rounded-full flex items-center justify-center text-xs font-semibold font-figtree transition-all duration-300",
          step === 3 ? "bg-[#0F2757] text-white" : "bg-[#EEEFF1] text-gray-500"
        )}>
          3
        </div>
      </div>
  ...
  return (
    <div className="w-full lg:w-[480px] flex flex-col items-center justify-center min-h-screen px-4 mx-auto">
      ...
      <div className="w-full bg-white rounded-[16px] border border-gray-200 p-[31px] flex flex-col animate-fadeIn shadow-sm">
          ...
          <div className="flex flex-col gap-6 mt-1.5 translate-y-1">
            ...
            <form onSubmit={handleEmailSubmit} className="flex flex-col gap-5" noValidate>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full h-[48px] rounded-[10px] bg-[#0F2757] hover:bg-[#162259] active:bg-[#091a3c] text-white text-base transition-all duration-150 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-75 font-figtree font-medium shadow-lg shadow-[#0F2757]/10"
              >
                {isLoading ? (
                  <>
        ...
        {step === 2 && (
          <div className="flex flex-col gap-6 mt-2">
            <div className="flex flex-col gap-3">
              ...
              <div className="w-12 h-12 bg-[#0F27571A] rounded-[8px] flex items-center justify-center text-[#0F2757]">
            ...
            <form onSubmit={handleCodeVerify} className="flex flex-col gap-6" noValidate>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full h-[48px] rounded-[10px] bg-[#0F2757] hover:bg-[#162259] active:bg-[#091a3c] text-white text-base transition-all duration-150 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-75 font-figtree mt-0.5 shadow-lg shadow-[#0F2757]/10"
              >
                {isLoading ? (
                  <>
                    <svg className="animate-spin h-5 w-5 text-white" fill="none" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col gap-6 mt-2 translate-y-0.5">
            ...
            <form onSubmit={handlePasswordReset} className="flex flex-col gap-5" noValidate>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full h-[48px] rounded-[10px] bg-[#0F2757] hover:bg-[#162259] active:bg-[#091a3c] text-white text-base transition-all duration-150 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-75 font-figtree mt-1.5 shadow-lg shadow-[#0F2757]/10"
              >
                {isLoading ? (
                  <>
                    <svg className="animate-spin h-5 w-5 text-white" fill="none" viewBox="0 0 24 24">
        ...
        {step === "success" && (
          <div className="flex flex-col items-center text-center gap-4 animate-fadeIn">
            ...
            <Link
              href="/auth/login"
              className="w-full h-[48px] rounded-[10px] bg-[#0F2757] hover:bg-[#162259] active:bg-[#091a3c] text-white text-base font-figtree transition-colors duration-150 cursor-pointer translate-y-0.5 shadow-lg shadow-[#0F2757]/10 flex items-center justify-center"
            >
              Continue to login
            </Link>
          </div>
