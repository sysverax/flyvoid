...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "px-4 pt-1 text-left text-[12px] font-medium uppercase leading-[100%] tracking-[0%] text-gray-500 align-middle [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px] h-[40px]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "h-14 px-4 py-2 text-sm text-gray-900 align-middle [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
      className
    )}
    {...props}
  />
