      ...
      <div className="flex items-center gap-6 mt-2">
        <div className="flex h-[34px] items-center gap-[8px]">
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="w-[75px] flex items-center justify-between border border-[#D1D5DB] text-[#6B7280] py-1.5 pl-3 pr-2.5 rounded-[8px] text-[14px] font-medium hover:bg-gray-50 cursor-pointer focus:outline-none transition-all h-[34px] font-urbanist"
            >
              <span className="text-gray-500 text-[14px] font-medium">{resultsPerPage}</span>
              <ChevronDown
                className={cn(
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isSelected
                          ? "bg-[#0F2757] text-white font-semibold"
        ...
        <div className="flex h-[34px] items-center gap-[5px]">
          <button
            ...
            className="h-[34px] w-[34px] flex items-center justify-center cursor-pointer rounded-[8px] border border-1.5 border-[#D1D5DB] text-[#1F2937] transition-colors hover:bg-gray-50"
          >
            <ChevronDown className="w-4 h-4 rotate-90 text-gray-500" strokeWidth={2.5} />
          </button>
